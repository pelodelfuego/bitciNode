...
curl -H "Content-Type: application/json" -X POST -d '{"type":"sequence","action":[{"type":"onOff","target":"Lumière N01","action":"on"}, {"type":"onOff","target":"Lsqkdj1","action":"off"}]}' http://localhost:3000/cmd
